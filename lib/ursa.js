...
var ursaNative = require("./binding")();
...
function PublicKey(rsa) {
    ...
    function toPublicSshFingerprint(encoding, algorithm) {
        return sshFingerprint(createSshPublicKey(rsa), undefined, encoding, algorithm);
    }
 ...
 * public key.
 */
function sshFingerprint(sshKey, sshEncoding, outEncoding, algorithm) {
